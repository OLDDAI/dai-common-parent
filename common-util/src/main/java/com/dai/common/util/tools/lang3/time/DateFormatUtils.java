 ...
 */
package com.dai.common.util.tools.lang3.time;
...
import static com.dai.common.util.tools.lang3.time.DateFormatConstant.*;

/**
 * <p>Date and time formatting utilities and constants.</p>
 *
 * <p>Formatting is performed using the thread-safe
 * {@link com.dai.common.util.tools.lang3.time.FastDateFormat} class.</p>
 *
...
public class DateFormatUtils {
    ...
    public static final FastDateFormat DASH_DATETIME_FAST_FORMAT
            = FastDateFormat.getInstance(DASH_DATETIME_FORMAT);
    /**
     ...
     * @since 3.5
     */
    public static final FastDateFormat DASH_T_DATETIME_FAST_FORMAT
            = FastDateFormat.getInstance(DASH_T_DATETIME_FORMAT);

    /**
     * @deprecated - as of 4.0, ISO_DATETIME_FORMAT will be replaced by ISO_8601_EXTENDED_DATETIME_FORMAT.
     */
    @Deprecated
    public static final FastDateFormat ISO_DATETIME_FORMAT = DASH_T_DATETIME_FAST_FORMAT;
     ...
     * @since 3.5
     */
    public static final FastDateFormat DASH_TZZ_DATETIME_FAST_FORMAT
            = FastDateFormat.getInstance(DASH_TZZ_DATETIME_FORMAT);

    /**
     * @deprecated - as of 4.0, ISO_DATETIME_TIME_ZONE_FORMAT will be replaced by ISO_8601_EXTENDED_DATETIME_TIME_ZONE_FORMAT.
     */
    @Deprecated
    public static final FastDateFormat ISO_DATETIME_TIME_ZONE_FORMAT = DASH_TZZ_DATETIME_FAST_FORMAT;
     ...
     * @since 3.5
     */
    public static final FastDateFormat DASH_DATE_FAST_FORMAT
            = FastDateFormat.getInstance(DASH_DATE_FORMAT);
    /**
     * @deprecated - as of 4.0, ISO_DATE_FORMAT will be replaced by ISO_8601_EXTENDED_DATE_FORMAT.
     */
    @Deprecated
    public static final FastDateFormat ISO_DATE_FORMAT = DASH_DATE_FAST_FORMAT;
     ...
     */
    @Deprecated
    public static final FastDateFormat DASH_ZZ_DATE_FAST_FORMAT
            = FastDateFormat.getInstance(DASH_ZZ_DATE_FORMAT);
    /**
    ...
    @Deprecated
    public static final FastDateFormat T_TIME_FAST_FORMAT
            = FastDateFormat.getInstance(T_TIME_FORMAT);
     ...
     */
    @Deprecated
    public static final FastDateFormat TZZ_TIME_FAST_FORMAT
            = FastDateFormat.getInstance(TZZ_TIME_FORMAT);
    /**
     ...
     * @since 3.5
     */
    public static final FastDateFormat TIME_FORMAT_FAST_FORMAT
            = FastDateFormat.getInstance(TIME_FORMAT);

    /**
     * @deprecated - as of 4.0, ISO_TIME_NO_T_FORMAT will be replaced by ISO_8601_EXTENDED_TIME_FORMAT.
     */
    @Deprecated
    public static final FastDateFormat ISO_TIME_NO_T_FORMAT = TIME_FORMAT_FAST_FORMAT;
     ...
     * @since 3.5
     */
    public static final FastDateFormat ZZ_TIME_FAST_FORMAT
            = FastDateFormat.getInstance(ZZ_TIME_FORMAT);

    /**
     * @deprecated - as of 4.0, ISO_TIME_NO_T_TIME_ZONE_FORMAT will be replaced by ISO_8601_EXTENDED_TIME_TIME_ZONE_FORMAT.
     */
    @Deprecated
    public static final FastDateFormat ISO_TIME_NO_T_TIME_ZONE_FORMAT = ZZ_TIME_FAST_FORMAT;
     ...
     * </p>
     */
    public static final FastDateFormat US_DATETIME_FAST_FORMAT
            = FastDateFormat.getInstance(US_DATETIME_FORMAT);
