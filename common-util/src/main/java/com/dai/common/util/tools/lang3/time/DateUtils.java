...
import com.dai.common.util.tools.lang3.Validate;
...
public class DateUtils {
    ...
    public static Date truncate(final Long dateOfMillis, final int field) {
        validateDateNotNull(dateOfMillis);
        final Calendar gval = Calendar.getInstance();
        gval.setTimeInMillis(dateOfMillis);
        modify(gval, field, ModifyType.TRUNCATE);
        return gval.getTime();
    }
...
// ----------------- Fix for LANG-440 ---------------------- END ---------------
    ...
    private static void validateDateNotNull(final Long dateOfMillis) {
        Validate.notNull(dateOfMillis, "The dateOfMillis must not be null");
    }
