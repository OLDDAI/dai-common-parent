...
public class MyCustomCommentGenerator implements CommentGenerator {
    ...
    private static String authorTag = "author";
    ...
    public void addModelClassComment(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        topLevelClass.addJavaDocLine(" * @author " + properties.getProperty(authorTag));
        topLevelClass.addJavaDocLine(" * @version " + properties.getProperty(versionTag));
